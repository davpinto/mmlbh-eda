...
author: "David Pinto | *CAO Nexer Labs*"
date:   "16 Março 2017"
output:
...
g <- ggmap::ggmap(map, extent = "device", darken = 0.2) +
   geom_curve(aes(x = orig_lon, y = orig_lat, xend = dest_lon, yend = dest_lat, 
                  color = dep_delay, alpha = dep_delay), data = dt, size = .7, curvature = 0.3,
              alpha = 0.8) +
   ...
   coord_cartesian() +
   viridis::scale_color_viridis(guide = "none", option = "B", direction = -1) +
